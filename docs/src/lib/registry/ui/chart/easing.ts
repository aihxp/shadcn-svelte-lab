 ...
 * Gentle acceleration with strong deceleration, matching Recharts' default.
 */
export const ease = createCubicBezier(0.25, 0.1, 0.25, 1.0);

/** Default motion config for splines, pies, and arcs. */
export const defaultMotion = { type: "tween", duration: 1500, easing: ease } as const;

/** Default motion config for bar chart dimensions. */
